        ...
        <ScrollView>
          <View style={styles.screenlayout}>
            ...
            <View style={styles.findprogram}>
              <Text
                style={{fontSize: 31, fontWeight: 'bold', color: '#22304A'}}>
                Abs Workout
              </Text>
              <View style={{marginTop: 5}}>
                ...
                <View>
                  <Text style={styles.findprogramtxt}>
                    Numbers of sessions:20
                  </Text>
                </View>
                <View>
                  <Text style={styles.findprogramtxt}>
                    Time of each sessions:40 mins
                  </Text>
                </View>
              </View>
            </View>
            <View style={{flexDirection: 'row', marginHorizontal: 12}}>
              ...
              <View style={styles.findprogram}>
                ...
                <View style={{}}>
                  ...
                  <View>
                    <Text style={styles.findprogramsubtxt}>
                      Duration:40 mins
                    </Text>
                  </View>
                  <View>
                    <Text style={styles.findprogramsubtxt}>
                      Numbers of workouts:6
                    </Text>
                  </View>
                  <View>
                    <Text style={styles.findprogramsubtxt}>
                      Numbers of sets per workouts:3
                    </Text>
                  </View>
                </View>
              </View>
